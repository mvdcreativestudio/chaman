<div class="card-checklist" id="card-checklist">
    <div class="x-heading clearfix">
        <span class="pull-left"><i class="mdi mdi-checkbox-marked"></i>Tareas</span>
    ...
    <div class="x-action">
        <a href="javascript:void(0)" class="js-card-checklist-toggle" id="card-checklist-add-new"
            data-action-url="{{ url('/leads/'.$lead->lead_id.'/add-checklist') }}" data-toggle="new">Agregar nueva</a>
    </div>
    @endif
</div>