...
<div class="col-lg-3 col-md-6 click-url cursor-pointer"
    data-url="{{ url('payments/search?ref=list&filter_payment_date_start='.$payload['filter_payment_this_year']['start_date'].'&filter_payment_date_end='.$payload['filter_payment_this_year']['end_date']) }}">
    <div class="card">
        <div class="card-body p-l-15 p-r-15">
            <div class="d-flex p-10 no-block">
                <span class="align-slef-center">
                    <h2 class="m-b-0">{{ runtimeMoneyFormat($payload['payments']['this_year']) }}</h2>
