                    ...
                    <div class="card-body p-l-15 p-r-15">
                        <div class="d-flex p-10 no-block">
                            <span class="align-slef-center">
                                ...
                                <h6 class="text-muted m-b-0">Chamán Pocitos</h6>
                            </span>
            ...
            <div class="col-lg-4 col-md-4 col-6 cursor-pointer pl-0">
                <div class="card">
                    <div class="card-body p-l-15 p-r-15">
                        <div class="d-flex p-10 no-block">
                            <span class="align-slef-center">
                                <h2 class="m-b-0">$38.000</h2>
                                <h6 class="text-muted m-b-0">Chamán Prado</h6>
                            </span>
                            <div class="align-self-center display-6 ml-auto"><i class="text-info icon-Coin"></i></div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-6 cursor-pointer pl-0">
                <div class="card">
                    <div class="card-body p-l-15 p-r-15">
                        <div class="d-flex p-10 no-block">
                            <span class="align-slef-center">
                                <h2 class="m-b-0">$45.000</h2>
                                <h6 class="text-muted m-b-0">Chamán Carrasco</h6>
                            </span>
                            <div class="align-self-center display-6 ml-auto"><i class="text-info icon-Coin"></i></div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-4 col-6 cursor-pointer pl-0">
                <div class="card">
                    <div class="card-body p-l-15 p-r-15">
                        <div class="d-flex p-10 no-block">
                            <span class="align-slef-center">
                                <h2 class="m-b-0">$12.000</h2>
                                <h6 class="text-muted m-b-0">Chamán Canelones</h6>
                            </span>
                            <div class="align-self-center display-6 ml-auto"><i class="text-info icon-Coin"></i></div>
                        </div>
                    </div>
