        ...
        <div class="card-body p-l-15 p-r-15">
            <div class="d-flex p-10 no-block">
                <span class="align-slef-center">
                    <h2 class="m-b-0">$7.400</h2>
                    <h6 class="text-muted m-b-0">Sucursal 4</h6>
                </span>
...
</div><?php /**PATH D:\laragon\www\application\resources\views/pages/datacenter/first-row/sucursal-cuatro.blade.php ENDPATH**/ ?>